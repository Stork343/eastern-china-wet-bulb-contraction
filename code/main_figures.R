###############################################################################
# Unified main-text figures for the manuscript.
#
...
corrected_dir <- file.path(project_dir, "results")
confirmatory_dir <- file.path(project_dir, "results")
dense_dir <- file.path(project_dir, "results")
noaa_extension_dir <- file.path(project_dir, "results")
output_dir <- file.path(project_dir, "results")
manuscript_root <- if (dir.exists(file.path(project_dir, "JASA", "manuscript"))) {
  file.path(project_dir, "JASA", "manuscript")
} else {
  file.path(project_dir, "manuscript")
}
manuscript_figure_dir <- file.path(manuscript_root, "figures")
...
primary_map_script <- file.path(code_dir, "primary_smooth_spatial_surfaces.R")
...
cat(paste(
  "Wrote unified main-text and supplementary figures as PDF files",
  "to results.\n"
))
