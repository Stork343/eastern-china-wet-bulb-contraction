#!/usr/bin/env python3
"""Extended analyses for the spatial wet-bulb contrast study.
...
def main() -> None:
    ...
    audit = {
        ...
        "outputs": [
            ...
            "../results/extended_spatial_convergence.csv",
            "../results/extended_spatial_convergence_summary.csv",
        ],
    }
