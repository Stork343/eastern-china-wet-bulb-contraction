...
\usepackage{booktabs,array,tabularx,graphicx,float,longtable,pdflscape}
...
\title{\textbf{Supplementary theory and analyses for ``Scale-dependent
contraction of spatial wet-bulb temperature contrasts in eastern China''}}
\author{Jian Hou, Tan Meng, and Maozai Tian}
\date{}
\maketitle
...
\begin{longtable}{P{0.22\textwidth}P{0.20\textwidth}P{0.22\textwidth}P{0.26\textwidth}}
...
\par\small\textit{Alt text:} A line descends smoothly as bandwidth increases
...
\par\small\textit{Alt text:} Four lines compare each spatial support with the
