...
\usepackage{booktabs,tabularx,float,longtable}
...
extensions were designed before their respective data were retrieved.

\footnotesize
\setlength{\tabcolsep}{3pt}
\begin{longtable}{Z{0.22\textwidth}Z{0.20\textwidth}Z{0.22\textwidth}Z{0.26\textwidth}}
\caption{Sequence and purpose of the applied analyses.}
\label{tab:status}\\
\toprule
...
Primary specification & 2015 and 2022 design summers &
Definition of the evaluation-period estimand \\

33-summer evaluation-period contrast &
Primary finite-record estimate & 33 evaluation summers &
Evaluation-period estimate \\
...
Exploratory analyses & 33 evaluation summers and outcome-free simulations &
Reference inference, structural decomposition and sensitivity analyses \\
...
Temporal extension and its product-shift calculation \\
...
Exploratory simulations & Outcome-free simulated records &
Estimator behaviour and randomisation calibration \\
\end{longtable}
\normalsize
...
Equation~\eqref{eq:s-cyclic-null}. The scale-wise rows use the same joint draws
...
calculated with the same Bolton implementation used for ERA5-Land.
...
for common events on a sparse station network. Coverage is weakest at 126 and
252 km.
...
not imply this product condition. The stress test uses the 121
...
Thus rejection remained near its nominal level for these simulated departures
from joint product invariance.
